...
namespace UniversityWebApp.Controllers
{
    public class TurmasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TurmaID,Codcred,Horario,Numero")] Turma turma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TurmaID,Codcred,Horario,Numero")] Turma turma)
        {
            if (id != turma.TurmaID)
            {
                return NotFound();
