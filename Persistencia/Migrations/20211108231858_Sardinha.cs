...
{
    public partial class Sardinha : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ItemHistoricoID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Codcred = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Historico", x => x.ItemHistoricoID);
                    table.ForeignKey(
                        name: "FK_Historico_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matricula_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Historico_ApplicationUserId",
                table: "Historico",
